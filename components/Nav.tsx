...
export default function Nav() {
  return (
    <header className="w-full h-10 relative">
      {/* Links */}
      <nav className="relative h-full w-1/6 mr-10 float-right">
        {/* Chat */}
        <div className="float-right absolute right-1 top-1/2 transform -translate-y-1/2">
          <div className="relative">
            <div className="bg-green-200 absolute -right-2 text-center leading-5 text-sm rounded-full w-5 h-5">
              +1
            </div>
        ...
        {/* User */}
        <div className="flex space-x-2 absolute top-1/2 transform -translate-y-1/2">
          <Image
            src="/user.png"
            width={26}
            height={26}
